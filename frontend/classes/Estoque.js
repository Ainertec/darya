...
function telaDeBuscarEstoque() {
    ...
    codigoHTML += '<input id="nome" type="text" class="form-control form-control-sm mousetrap" placeholder="Nome do produto">'
...
async function buscarEstoque(tipoBusca) {
    ...
    codigoHTML += '<table class="table table-bordered table-sm col-8 mx-auto" style="margin-top:10px">'
