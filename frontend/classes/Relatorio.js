...
function telaDeRelatorio() {
    ...
    codigoHTML +=
        '<div class="card-deck col-4 mx-auto d-block" style="margin-top:30px;">'
    ...
    codigoHTML +=
        `<button type="button" class="btn btn-outline-primary"><span class="fas fa-search"></span> Relatórios periódicos</button>`
    codigoHTML +=
    ...
    codigoHTML += '<div id="grafico0" style="margin-top:40px;" class="col-12 rounded mx-auto d-block"></div>'
...
function gerarGraficoLucroTotalPeriodico() {
    Highcharts.chart('grafico0', {
        ...
        subtitle: {
            text: 'Gráfico responsavel por demonstrar o lucro líquido e bruto arrecadados dentro de um determinado período.'
        },
        xAxis: {
            categories: [
                'Lucro total'
