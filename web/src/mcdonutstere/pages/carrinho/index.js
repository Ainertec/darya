...
function getStepContent(step) {
    switch (step) {
        ...
        default:
            return <>
                <Typography variant="h6" component="h3" style={{ color: 'red', textAlign: 'center' }}>
        ...
        <div className={classes.colorPag}>
            ...
            <Container maxWidth="md" disableGutters>
                <Box justifyContent="center" flexWrap="wrap" display="flex" className={classes.root}>
                    <div>
                        <Stepper activeStep={posicaoNavegacao} alternativeLabel className={classes.cabecaloProgressoStyle}>
                            {cabecario.map((label) => (
                                <Step key={label}>
                        ...
                        <div>
                            <div>
                                <Box justifyContent="center" flexWrap="wrap" display="flex" className={classes.root}>
                                    {getStepContent(posicaoNavegacao)}
                                </Box>
                                    ...
                                    {posicaoNavegacao < cabecario.length ?
                                        ...
                                        >
                                            ...
                                            <Button
                                                ...
                                                style={{ marginLeft: 30 }}
                                            >
                                                {posicaoNavegacao === cabecario.length - 1 ? <><DoneOutlineIcon /> Fazer Pedido</> : <>Continuar <SkipNextIcon /></>}
                                            </Button></>
                                        :
                                        <Button
                                            disabled={posicaoNavegacao === 0}
