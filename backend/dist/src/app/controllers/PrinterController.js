...
const soldReportUseCase_1 = require("../useCases/Printer/SoldPrinter/soldReportUseCase");
const deliverymanPaymentUseCase_1 = require("../useCases/Report/deliverymanPaymentUseCase");
const deliverymanPrinterUseCase_1 = require("../useCases/Printer/DeliverymanPrinter/deliverymanPrinterUseCase");
const soldPrinterUseCase_1 = require("../useCases/Printer/SoldPrinter/soldPrinterUseCase");
class PrinterController {
    ...
    async deliverymanPrint(request, response) {
        ...
        try {
            const deliverymanPayment = new deliverymanPaymentUseCase_1.DeliverymanPaymentUseCase(Order_1.default);
    ...
    async soldPrint(request, response) {
        try {
            ...
            const soldReportUseCase = new soldReportUseCase_1.SoldReportUseCase(Order_1.default, productsAmount);
