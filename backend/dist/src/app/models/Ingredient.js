        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.all(products.map(function (product) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, getProductCost_1.default(product.ingredients)];
                                case 1:
                                    cost = _a.sent();
                                    product.cost = cost;
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.all(products.map(function (product) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ingredientUpdated = product.ingredients.filter(function (ingredient) { return String(ingredient.material) !== String(ingredientID_1); });
