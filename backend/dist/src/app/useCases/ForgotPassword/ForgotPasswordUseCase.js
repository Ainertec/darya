...
var ForgotPasswordUseCase = /** @class */ (function () {
    ...
    ForgotPasswordUseCase.prototype.getClientQuestion = function (username) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { question: user.question }];
                }
            });
        });
    };
    ForgotPasswordUseCase.prototype.reset = function (username, response, newPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
