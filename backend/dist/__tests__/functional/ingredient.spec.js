...
describe('should test a ingredient', function () {
    beforeAll(function () {
    ...
    it('should update  a ingredient', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ingredient = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).put("/ingredients/" + ingredient._id).send({
                            name: 'chocolate',
                            price: 2.0,
                            stock: 20,
                            unit: 'g',
    ...
    it('should list all ingredients by name', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, factories_1.default.create('Ingredient', { name: 'Farinha' })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, factories_1.default.create('Ingredient', { name: 'Chocolate' })];
                case 2:
                    _a.sent();
