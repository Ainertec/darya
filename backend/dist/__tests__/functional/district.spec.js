...
describe('should test', function () {
    ...
    it('should create a district', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.default).post('/districts').send({
                        name: 'Lumiar',
                        city: 'Nova Friburgo',
                        rate: 10,
                    })];
    ...
    it('should update a district', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    district = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).put("/districts/" + district._id).send({
                            name: 'Lumiar',
                            city: district.city,
                            rate: 10,
                        })];
    ...
    it('should delete a district', function () { return __awaiter(void 0, void 0, void 0, function () {
        var district, response, countDocuments;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, factories_1.default.create('District')];
                case 1:
                    district = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).delete("/districts/" + district._id)];
                case 2:
                    response = _a.sent();
    ...
    it('should list all districts', function () { return __awaiter(void 0, void 0, void 0, function () {
        var district, district2, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, factories_1.default.create('District', {
                        name: 'Lumiar',
                ...
                case 2:
                    district2 = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).get('/districts')];
                case 3:
                    response = _a.sent();
                    expect(response.status).toBe(200);
    ...
    it('should list all districts by name', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    district2 = _a.sent();
                    return [4 /*yield*/, supertest_1.default(app_1.default).get("/districts/s")];
                case 3:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    expect(response.body).toEqual(expect.arrayContaining([
